...
```
<product or marketing challenge>
```

Examples:
```
AI scheduling tool for remote teams — need launch marketing
Help me position our analytics product against enterprise competitors
We need a name for our new developer productivity feature
```

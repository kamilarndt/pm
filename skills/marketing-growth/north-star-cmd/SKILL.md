...
metadata:
  hermes:
    tags: [product-management, marketing-growth]
---
...
Examples:
```
B2B SaaS for team collaboration
Consumer fitness app monetized through subscriptions
Help me fix our North Star — we're tracking DAU but it doesn't feel right
```
...
- The North Star should measure *value delivered*, not just *activity* — "daily active users" is only good if active use equals value delivery

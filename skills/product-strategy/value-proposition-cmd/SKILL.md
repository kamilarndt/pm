...
```
<product or feature>      - product or feature description
```
...
- Value Proposition is one element of product strategy — use the strategy command for the full picture

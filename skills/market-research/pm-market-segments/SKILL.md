...
### Input
Your task is to identify and analyze potential customer segments for **the product or service**.
...
1. **Market Exploration**: Consider the full addressable market for the product or service
...
- How well the product serves this segment's needs

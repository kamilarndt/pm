...
Użycie: `<research data, survey results, or product description>`
...
- `upload survey results, interview notes, or feedback data`
- `B2B project management tool for agencies — help me understand our users`
- `paste user feedback or support ticket data`

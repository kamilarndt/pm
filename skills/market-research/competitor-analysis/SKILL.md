...
metadata:
  hermes:
    tags: [product-management, market-research]
---
...
### Input
Your task is to analyze the competitive landscape for **the product or service** in the **[market/industry segment]** (if specified).
...
1. **Market Scoping**: Define the market, industry, and addressable customer base for the product or service
...
- How this competitor threatens your product
...
- Recommended competitive positioning for your product

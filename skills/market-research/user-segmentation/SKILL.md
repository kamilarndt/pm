...
### Input
Your task is to segment users for **the product or service** based on behavior, jobs-to-be-done, and unmet needs.
...
- How this segment uses the product (primary use cases, frequency, depth)
...
**Current Product Fit**
- How well the product currently serves this segment

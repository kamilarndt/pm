...
```
<data file or description of what to analyze>
```

## Invocation

```
Upload a CSV of user activity data
For example: Monthly retention for users who signed up in Jan-Jun, grouped by acquisition channel
For example: Help me set up a cohort analysis for our onboarding redesign
```

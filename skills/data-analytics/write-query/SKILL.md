...
metadata:
  hermes:
    tags: [product-management, data-analytics]
---
...
```
<what you want to know, in plain English>
```

## Invocation

```
Show me daily active users for the last 30 days, broken down by plan tier
For example: Find users who signed up last month but never completed onboarding
For example (upload a schema diagram): What's the conversion rate from trial to paid by cohort?
```

...
```
<test results as data, screenshot, or description>
```

## Invocation

```
Control: 4.2% conversion (n=5000), Variant: 4.8% conversion (n=5100)
For example: Upload a CSV of test results
For example: Screenshot from your experimentation platform
```

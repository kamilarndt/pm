...
metadata:
  hermes:
    tags: [product-management, go-to-market]
---
...
```
<product or growth challenge>
```

Examples:
```
B2B collaboration tool — growth has stalled at 5K users
Consumer fitness app looking for viral growth
```
You can also upload product metrics or growth data.
...
- Building product-led or sales-led growth strategies
- Analyzing why growth has stalled
- Planning sustainable acquisition beyond paid channels
...
- CAC should be less than 1/3 of LTV for sustainable growth — flag if projected CAC is too high

...
# Go-to-Market Strategy (Plan Launch)
...
Examples:
```
AI-powered proposal writer for consulting firms
New enterprise tier for our project management tool
```
You can also upload a PRD, strategy doc, or pitch deck.
...
- Creating a GTM strategy from scratch
- Defining launch strategy for a new market
- Building a complete go-to-market plan

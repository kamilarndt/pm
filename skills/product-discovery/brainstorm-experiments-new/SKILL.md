...
metadata:
  hermes:
    tags: [product-management, discovery, experiments, new-product, validation, lean-startup, pretotyping]
---
...
You are helping validate a new product concept using lean startup methodology.

...
metadata:
  hermes:
    tags: [product-management, discovery, opportunity-solution-tree, continuous-discovery, teresa-torres, product-trio]
---
...
You are helping a product team build an Opportunity Solution Tree.

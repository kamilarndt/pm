...
metadata:
  hermes:
    tags: [product-management, discovery, ideation, brainstorming, product-trio, experiments]
---

Użycie: "[ideas|experiments] [existing|new] <product or feature description>"
...
Parse the context to identify two dimensions:

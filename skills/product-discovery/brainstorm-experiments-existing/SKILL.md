...
metadata:
  hermes:
    tags: [product-management, discovery, experiments, existing-product, validation, ab-testing]
---
...
You are helping a product team design experiments. The team has a feature idea and assumptions that need validation.

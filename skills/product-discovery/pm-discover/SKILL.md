...
metadata:
  hermes:
    tags: [product-management, discovery, full-cycle, workflow]
---

Użycie: "<product or feature idea>"

## Discover — Full Discovery Cycle

Run a structured product discovery process that moves from divergent thinking to focused validation. This chains multiple skills into a single end-to-end workflow.

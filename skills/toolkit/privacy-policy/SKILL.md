...
## Użycie
<product and data handling context>

## Quick Start

```
SaaS analytics tool that collects user behavior data — serving US and EU customers
Mobile app with location data and third-party integrations
```

Provide context about your product and data handling, and a full privacy policy will be drafted.
...
- **Complete information types**: Use the provided information types to make the policy specific to your actual data collection

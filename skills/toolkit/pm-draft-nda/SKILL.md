...
```
Mutual NDA between our startup and a potential enterprise customer
One-way NDA for a freelance contractor accessing our codebase
```

Provide details about the parties and the context of the agreement.
...
- **Specific Information Types**: Use the provided information types to make the agreement specific, not generic.
- **Mutual or One-Way**: If information sharing is one-way, note this as a one-way NDA. If both, use mutual language.

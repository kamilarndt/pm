...
metadata:
  hermes:
    tags: [product-management, toolkit]
---
...
## Użycie
<resume as text or file>

## Quick Start

```
Paste your resume text here, or upload the resume PDF or DOCX file.
```

Optionally provide a job posting to get tailored feedback against a specific role.
...
**Evaluation:**
- If a job posting is provided, scan resume for keywords from the job description
...
Product and business acumen should be evident in bullet points, not just listed as skills.

**Evaluation:**
- Scan for product-specific language (discovery, validation, prioritization, roadmap, experiments)
- Check if business impact is clear (revenue, retention, engagement, cost savings)

**Guidance:**
- Replace generic "led product development" with specific product activities: "Conducted 30 user discovery interviews to identify top pain points, leading to feature prioritization that reduced churn by 18%"
- Showcase frameworks used: OKRs, jobs-to-be-done, design thinking, etc.
...
- Highlight internships with clear PM-like responsibilities
- Showcase personal projects
- If transitioning from another field, frame experience through a PM lens

---

### Best Practice 10: Use Standard Language and Job Titles
Use clear, standard job titles and language. Avoid made-up or overly creative job titles.
...
**Guidance:**
- Use standard PM titles: Product Manager, Senior Product Manager, APM, Principal Product Manager
- Avoid: "Product Ninja," "Chief Growth Officer" (unless actually the title), "Product Guru"
- **Product Owner vs Product Manager**: Product Owner is accountability in Scrum, Product Manager is a job title. If the candidate's official title was PO but they acted as a full PM, recommend using "Product Manager" on the resume.
...
- **Align with job posting**: If a job posting is provided, bias feedback toward job requirements.
